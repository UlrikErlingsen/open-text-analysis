...
## Public foundations used

- term frequency, document frequency, and TF–IDF: Salton and Buckley (1988);
- non-negative matrix factorization: Lee and Seung (1999);
- informative-Dirichlet smoothed log odds: Monroe, Colaresi, and Quinn (2008);
...
conditions, stability diagnostics, privacy-minimized exports, and a human codebook handoff.
...
- top terms reveal author intention;
- lexical difference explains group behavior;
- automated context masking anonymizes text;
